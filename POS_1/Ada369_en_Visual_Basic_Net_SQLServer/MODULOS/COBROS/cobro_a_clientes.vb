...
Public Class cobro_a_clientes
    ...
    Sub Saldo()
        ...
        If importe = 0 Then
            editar_estado_de_detalle_ventas_a_cobrado()
            cargar_estado_de_cuenta()
        End If
    End Sub
    Sub editar_estado_de_detalle_ventas_a_cobrado()
        Try
            Dim cmd As New SqlCommand
            abrir()
            cmd = New SqlCommand("Editar_estado_detalle_venta_a_cobrado", conexion)
            cmd.CommandType = 4
            cmd.Parameters.AddWithValue("@Saldo", txttotal_saldo.Text)
    ...
    Private Sub cobro_a_clientes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'txtclientesolicitante.Text = "Buscar cliente/ deudor"
    ...
    Sub cargar_estado_de_cuenta()
        ...
        Try
            ...
            datalistadoHistorial.Columns(5).Width = 200
        ...
        For Each row As DataGridViewRow In datalistadoHistorial.Rows
            If row.Cells("Estado").Value = "OTRAS CUENTAS COBRADO" Then
                row.DefaultCellStyle.Font = New Font("Segoe UI", 10, FontStyle.Strikeout Or FontStyle.Bold)
                row.DefaultCellStyle.ForeColor = Color.FromArgb(255, 192, 192)
            End If
        Next
    End Sub
    ...
    Private Sub datalistadoclientes_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistadoclientes.CellClick
        ...
        Try
            ...
            idcliente = datalistadoclientes.SelectedCells.Item(2).Value
            datalistadoclientes.Visible = False
            cargar_estado_de_cuenta()
    ...
    Sub mostrar_historial()
        ...
        PanelM.Visible = False
    End Sub
    Private Sub LHistorial_Click(sender As Object, e As EventArgs) Handles LHistorial.Click
        mostrar_historial()
    End Sub

    Private Sub LMovimientos_Click(sender As Object, e As EventArgs) Handles LMovimientos.Click
        mostrar_DETALLE_CONTROL_DE_COBROS()
    ...
    Private Sub ToolStripMenuItem11_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem11.Click
        Try
            ...
            If txttotal_saldo.Text > 0 Then
                Try

                    Medios_de_Cobros.ShowDialog()
    ...
    Private Sub TimerSUMAR_SALDO_Tick(sender As Object, e As EventArgs) Handles TimerSUMAR_SALDO.Tick
        Saldo()
        TimerSUMAR_SALDO.Stop()
    End Sub
    ...
    Private Sub cobro_a_clientes_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Dispose()
    End Sub
End Class