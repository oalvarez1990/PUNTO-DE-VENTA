...
Public Class Cambio_de_usuario
    ...
    Sub editar_inicio_De_sesion()
        Try
            ...
            cmd.ExecuteNonQuery()
            Cerrar()
            VENTAS_MENU_PRINCIPAL.mostrar_inicio_De_sesion()
            VENTAS_MENU_PRINCIPAL.mostrar_usuario_logueado()
        Catch ex As Exception
            MsgBox(ex.StackTrace)
        End Try
    ...
    Private Sub TimerVALIDACION_DE_ROLES_Tick(sender As Object, e As EventArgs) Handles TimerVALIDACION_DE_ROLES.Tick
        ...
        Else
                ...
                ElseIf lblApertura_De_caja.Text <> "Nuevo*****" And LBLROL.Text <> "Solo Ventas (no esta autorizado para manejar dinero)" Then
                    editar_inicio_De_sesion()
                    MASCARA1.Dispose()
                    VENTAS_MENU_PRINCIPAL.Dispose()
                    Dispose()
