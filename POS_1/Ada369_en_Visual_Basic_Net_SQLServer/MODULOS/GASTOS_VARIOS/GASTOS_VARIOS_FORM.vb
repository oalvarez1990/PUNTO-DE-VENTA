...
Public Class GASTOS_VARIOS_FORM
    ...
    Sub INGRESAR_GASTO_ENTRADA()
        If txtobservacion.Text = "" Then txtobservacion.Text = "Sin detallar"
        Dim cmd As New SqlCommand
        Try
            abrir()
    ...
    Private Sub calculadora()
        ...
        End Select
    End Sub
    Private Sub gastosvarios_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) _
    ...
    Private Sub gastosvarios_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Id_usuario.Text = VENTAS_MENU_PRINCIPAL.lblidusuario.Text
        TXTCONCEPTO.Text = ""
        Label5.Visible = True
    End Sub
