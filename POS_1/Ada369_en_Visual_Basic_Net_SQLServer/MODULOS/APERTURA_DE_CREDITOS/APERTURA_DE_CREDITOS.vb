...
Public Class APERTURA_DE_CREDITOS
    ...
    Sub ListarPOR_PAGAR()
        Try
            abrir()
            Dim da As New SqlCommand("mostrar_id_venta_por_serialPC", conexion)
            da.CommandType = 4
            da.Parameters.AddWithValue("@SerialPc", lblIdSerial.Text)
            txtidventa.Text = da.ExecuteScalar()
            Cerrar()
        Catch ex As Exception
    ...
    Private Sub ToolStripMenuItem17_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem17.Click
        ...
        If lblTipo.Text = "POR PAGAR" Then
            ...
            Rregistro_de_proveedores.indicador = "APERTURA DE CREDITOS"

            Rregistro_de_proveedores.ShowDialog()

        End If
        If lblTipo.Text = "POR COBRAR" Then
            Registro_clientes.indicador = "APERTURA DE CREDITOS"
    ...
    Sub agregar_datos()
        Try
            ...
            cmd.Parameters.AddWithValue("@Comprobante", "Ticket Otros@" & txtidventa.Text)
            ...
            ListarPOR_PAGAR()
            insertar_POR_PAGAR()
            DASHBOARD_PRINCIPAL.SUMAR_NOTIFICACIONES()
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    ...
    Sub insertar_POR_PAGAR()
        ...
        Try
            If txtconcepto.Text = "" Then txtconcepto.Text = "SIN DETALLAR"
            Dim cmd As New SqlCommand
            abrir()
            ...
            cmd.CommandType = 4
            cmd.Parameters.AddWithValue("@idventa", txtidventa.Text)
            cmd.Parameters.AddWithValue("@Id_presentacionfraccionada", 1)
            ...
            Iniciar_form()
            DASHBOARD_PRINCIPAL.sumar_Cuentas_por_pagar()
            DASHBOARD_PRINCIPAL.SUMAR_POR_COBRAR_OK()
        Catch ex As Exception
            'MsgBox("Fallo insertar_detalle_venta")
        End Try
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        MASCARA1.Hide()
        Close()
        DASHBOARD_PRINCIPAL.TimerCerrar_Aperturas_de_credito.Start()
        VENTAS_MENU_PRINCIPAL.TimerCerrar_Aperturas_de_credito.Start()
    ...
    Private Sub txtetiqueta_MouseEnter(sender As Object, e As EventArgs)
