...
Public Class REGISTRO_DE_EMPRESA
    ...
    Private Sub ToolStripMenuItem1_Click_3(sender As Object, e As EventArgs) Handles TSIGUIENTE_Y_GUARDAR_.Click
        ...
        Else
            If txtRuta.Text <> "" Then
                ...
                If txtcaja.Text <> "" Then
                    If txtempresa.Text = "" Then txtempresa.Text = "NOMBRE DE TU EMPRESA"
                    ...
                    Try
                        ...
                        USUARIOS_AUTORIZADOS_AL_SISTEMA.correo = txtcorreo.Text
                        Dispose()
                        USUARIOS_AUTORIZADOS_AL_SISTEMA.ShowDialog()
                ...
                Else
                    MessageBox.Show("Ingrese un nombre de la Caja", "Nombre de Caja en Blanco", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Sub insertar_caja()
        Try
            ...
            cmd.Parameters.AddWithValue("@Serial_PC", Encriptar(lblIDSERIAL.Text))
    ...
    Sub insertar_3_COMPROBANTES_POR_DEFECTO()
        Try
            ...
            Try
                abrir()
                cmd = New SqlCommand("AUTORIZAR_A_USUARIOS_PARA_QUE_PROPIETARIO_DE_BASE_DE_DATOS", conexion)
                cmd.ExecuteNonQuery()
                Cerrar()
            Catch ex As Exception
