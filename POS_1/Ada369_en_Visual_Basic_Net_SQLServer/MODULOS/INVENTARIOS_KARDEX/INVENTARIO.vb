...
Public Class INVENTARIO
    ...
    Private Sub TOTROSPAGOS_Click(sender As Object, e As EventArgs) Handles TReporteInventarios.Click
    ...
    Private Sub TNOTAS_Click(sender As Object, e As EventArgs) Handles TInventarios_bajos.Click
    ...
    Sub buscar_MOVIMIENTOS_FILTROS()
        ...
        Try
            ...
            daListarpresentacionesagregadas.SelectCommand.Parameters.AddWithValue("@Id_usuario", txtIdusuario.Text)
    ...
    Sub Buscar_id_USUARIOS()
        ...
        Catch ex As Exception
        End Try
        txtIdusuario.Text = importe  ' mostramos el importe
    End Sub
    ...
    Private Sub TimerVencimientos_Tick(sender As Object, e As EventArgs) Handles TimerVencimientos.Tick
        CheckProductosVencidos.Checked = False
        CheckPorVenceren30Dias.Checked = False
        PanelR.Visible = False
        PanelK.Visible = False
