Public Class CANTIDAD_A_GRANEL
    ...
    Private Sub txtpantalla_TextChanged(sender As Object, e As EventArgs) Handles txtcantidad.TextChanged
        Try
            txtimporte.Text = txtprecio_unitario.Text * 1 * txtcantidad.Text * 1
        Catch ex As Exception
        End Try
    End Sub

    Private Sub txtprecio_actual_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtimporte.KeyPress
        If ((e.KeyChar = "."c) OrElse (e.KeyChar = ","c)) Then
            ' Obtenemos el carácter separador decimal existente
            ' actualmente en la configuración regional de Windows.
            ' 
    ...
    Private Sub txtprecio_actual_TextChanged(sender As Object, e As EventArgs) Handles txtimporte.TextChanged
        Try
            txtcantidad.Text = (txtimporte.Text * 1) / (txtprecio_unitario.Text * 1)
        Catch ex As Exception
