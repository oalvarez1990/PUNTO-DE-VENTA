...
Public Class HISTORIAL_DE_VENTAS
    ...
    Sub mostrar_productos_agregados_a_venta_historial()
        Try
            ...
            Try
                ...
                datalistado_detalle_de_venta.Columns(5).Visible = False
                ...
                datalistado_detalle_de_venta.Columns(15).Visible = False
                datalistado_detalle_de_venta.Columns(16).Visible = False

                Cerrar()
                sumar()
                Multilinea(datalistado_detalle_de_venta)
            Catch ex As Exception
    ...
    Private Sub datalistadoventas_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistadoventas_historial.CellClick
        Try
            ...
            lblcliente.Text = datalistadoventas_historial.SelectedCells.Item(11).Value
            LBLTipodePagoOK.Text = datalistadoventas_historial.SelectedCells.Item(8).Value
            lblpagocon.Text = datalistadoventas_historial.SelectedCells.Item(9).Value
            lblvuelto.Text = datalistadoventas_historial.SelectedCells.Item(10).Value
